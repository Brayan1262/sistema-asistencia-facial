    ...
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <RouterLink class="menu-link" to="/reconocimiento">
          <i class="bi bi-camera-fill"></i> Reconocimiento
        </RouterLink>

        <RouterLink class="menu-link active" to="/asistencia">
    ...
    <main class="main-content">
      <header class="topbar">
        <div>
          ...
          <p>Reconocimiento facial mediante imagen o cámara.</p>
        </div>
      </header>

      <div class="glass-card">
        <h4>Módulo Asistencia</h4>
        <p class="text-muted mb-0">
          Aquí migraremos cámara en vivo, reconocimiento y registro automático.
        </p>
      </div>
    </main>
  </div>
